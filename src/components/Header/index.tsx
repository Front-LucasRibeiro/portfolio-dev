        ...
        <div className="flex w-full flex-wrap items-center justify-between px-3">
          <div
            ...
            <ul
              ...
              <li className="mb-4 lg:mb-0 lg:pe-2" data-twe-nav-item-ref>
                <Link
                  className={`${navigate.pathname === "/sobre-mim" ? "active" : ""} block text-black/80 transition duration-200 hover:font-bold hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/80 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2`}
                  to="/sobre-mim"
                  data-twe-nav-link-ref
                  data-twe-ripple-init
                  data-twe-ripple-color="light"
